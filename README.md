...
- [nextjs-movies](https://github.com/pnvdev/nextjs-movies): A Next.js application to search for movies using the TMDB API, showcasing dynamic routing and debounced search functionality.
